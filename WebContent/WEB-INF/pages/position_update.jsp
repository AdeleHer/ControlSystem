...
<body>
	...
	<div class="container">
		<div class="row">
			<form class="form-horizontal" id="updatePositionForm">
				<input type="text" name="p_sn" value="<s:property value="sn" />"
					style="display: none;">
				<div class="form-group">
					<label class="col-sm-1 control-label">職稱</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="p_name"
							value="<s:property value="name" />" name="p_name">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-1 col-sm-10">
						<a href="javascript:submitForm();" class="btn btn-default">送出</a>
					</div>
				</div>
			</form>
		</div>
