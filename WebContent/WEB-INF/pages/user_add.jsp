		...
		<div class="row">
			<form class="form-horizontal" id="addUserForm">
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" name="u_account">
					</div>
				</div>
				<div class="form-group">
					...
					<div data-repeater-list="group-c">
						<div data-repeater-item class="mt-repeater-item"
							...
							<div class="row mt-repeater-row">
								...
								<div class="col-sm-5">
									<s:select class="form-control" list="groupList" value="1" name="GroupList" theme="simple">
									</s:select>
								</div>
								<div class=" col-sm-1">
				...
				<div class="form-group">
					<div class="col-sm-offset-1 col-sm-10">
						<a href="javascript:readySubmit();" class="btn btn-default">新增</a>
					</div>
				</div>
			</form>
		</div>
